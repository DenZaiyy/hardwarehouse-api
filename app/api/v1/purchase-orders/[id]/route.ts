...
export async function GET(_req: NextRequest, ctx: RouteContext<'/api/v1/protected/purchase-orders/[id]'>) {
    try {
...
export async function DELETE(_req: NextRequest, ctx: RouteContext<'/api/v1/protected/purchase-orders/[id]'>) {
    try {
        const { id } = await ctx.params;
        const purchaseOrder = await db.purchaseOrder.findUnique({
            where: {
